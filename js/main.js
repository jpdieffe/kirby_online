...
const WORDS = [
  'STAR', 'DREAM', 'POPSTAR', 'KIRBY', 'WARPSTAR', 'CAPPY', 'DEDEDE',
  'METAKNIGHT', 'WADDLE', 'HALCANDRA', 'RIPPLE', 'COOKIE', 'ONION',
  'BUBBLY', 'CHERRY', 'FOREST', 'RAINBOW', 'CRYSTAL', 'CANDY', 'NOVA',
  'MIRACLE', 'MAGOLOR', 'ELFILIN', 'BANDANA', 'LANDIA', 'SAGA', 'PEPPERMINT'
];
